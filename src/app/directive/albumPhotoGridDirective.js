(function () {
  ...
  function albumPhotoGridDirective(AppConfig, $q, Gallery, GalleryAlbum, Dialog, $rootScope, PhotoService, Loading, ParseFile, $translate, Toast, $ionicModal, $ionicPopover) {
    ...
    function albumPhotoGridCtrl($scope, elem, attr) {
      ...
      elem.bind('click', function () {
        ...
        function init() {
          $scope.loading = true;
          $q.all([GalleryAlbum.get($scope.album),
              Gallery.getAlbum({id: $scope.album})])
            .then(function (data) {
              console.log(data);
